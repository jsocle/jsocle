...
public class FormTest {
    ...
    fun test() {
        ...
        parameters(
            ...
            Assert.assertEquals(listOf(" john "), form.firstName.raw)
            ...
            Assert.assertEquals(listOf("noah"), form.firstName.raw)
            ...
            Assert.assertEquals(listOf<String>(), form.lastName.raw)
            ...
            Assert.assertEquals(listOf("31"), form.age.raw)
            ...
            Assert.assertEquals(listOf("42"), form.age.raw)
            ...
            Assert.assertEquals(listOf("1980s"), form.birthYear.raw)
            ...
            Assert.assertEquals(listOf("1980"), form.birthYear.raw)
    ...
    fun testValidate() {
        ...
        parameters(method = Request.Method.POST) {
            val form = TestForm()
